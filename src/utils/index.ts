...
export const generateCells = (): Cell[][] => {
    ...
    for (let rowIndex = 0; rowIndex < MAX_ROWS; rowIndex++) {
        for (let colIndex = 0; colIndex < MAX_COLUMNS; colIndex++) {
            ...
            (topLeftCell?.value === CellValue.bomb) && numberOfBombs++;
            (topCell?.value === CellValue.bomb) && numberOfBombs++;
            (topRightCell?.value === CellValue.bomb) && numberOfBombs++;
            (leftCell?.value === CellValue.bomb) && numberOfBombs++;
            (rightCell?.value === CellValue.bomb) && numberOfBombs++;
            (bottomLeftCell?.value === CellValue.bomb) && numberOfBombs++;
            (bottomCell?.value === CellValue.bomb) && numberOfBombs++;
            (bottomRightCell?.value === CellValue.bomb) && numberOfBombs++;
